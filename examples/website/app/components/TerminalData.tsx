...
export function TerminalData() {
  return (
    <>
      ...
      <DataElement id="file-go-mod">{FILE_GO_MOD}</DataElement>
      <DataElement id="file-agents-md">{FILE_AGENTS_MD}</DataElement>
      <DataElement id="file-version-go">{FILE_VERSION_GO}</DataElement>
      <DataElement id="file-website-readme">{FILE_WEBSITE_README}</DataElement>
