...
| `ExecutionResult` | Output from an execution: exit code, stdout, stderr, timing, and trace events. |
...
github.com/ewhauser/gbash/trace      Structured trace events emitted during execution
github.com/ewhauser/gbash/shell      Shell engine interface (mvdan/sh backend)
...
- [Runtime](/api/runtime) -- creating and configuring runtimes
- [Sessions](/api/sessions) -- persistent sandbox state across executions
- [Custom Commands](/api/custom-commands) -- extending the command registry
- [WebAssembly](/api/wasm) -- running gbash in the browser or Node.js
