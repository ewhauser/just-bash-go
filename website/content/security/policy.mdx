...
Each execution produces a sequence of structured `trace.Event` records returned in `ExecutionResult.Events`. Events use the `gbash.trace.v1` schema and include session and execution IDs for correlation.
